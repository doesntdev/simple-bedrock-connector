...
│                      │         │                                                  │
│  ┌────────────────┐  │   ②    │  ┌──────────────────┐                             │
│  │  Python Script  │──┼───────▶│  │ Secrets Manager   │                             │
│  │  generate_token │  │ store  │  │ token → identity  │◀──┐                         │
│  └───────┬────────┘  │ token  │  └──────────────────┘   │ ⑤ validate              │
│          │ ①         │         │                         │                          │
│          ▼           │         │  ┌──────────────────┐   │    ┌─────────────────┐   │
│  ┌────────────────┐  │         │  │   API Gateway     │   │    │   CloudWatch     │   │
│  │    AWS IAM      │  │         │  │   /v1/chat/...   │───┤    │   request logs   │   │
│  │  STS auth       │  │         │  └────────┬─────────┘   │    │   usage metrics  │   │
│  └────────────────┘  │         │           │ ④            │    └────────▲────────┘   │
│                      │         │           ▼              │             │ ⑥           │
│  ┌────────────────┐  │   ③    │  ┌──────────────────┐   │             │             │
│  │ AI Coding Tool  │──┼───────▶│  │     Lambda        │───┘             │             │
│  │ Cursor / Cline  │◀─┼───────│  │  validate + route │────────────────┘             │
│  │ Copilot / Aider │  │   ⑧   │  └────────┬─────────┘                               │
│  └────────────────┘  │ OpenAI │           │ ⑦                                       │
│                      │ format │           ▼                                          │
│                      │         │  ┌──────────────────┐                               │
